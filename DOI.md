A [Digital Object Identifier](https://www.doi.org/) (DOI) can be assigned to any digital object with any level granularity. DOIs usually resolve to specific URLs.
